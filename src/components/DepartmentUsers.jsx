...
export default function DepartmentUsers({ users, loading, loadError, onLogout, embedded = false }) {
  return (
    <div className={embedded ? undefined : "main-content"} style={embedded ? undefined : { maxWidth: 900, margin: "0 auto" }}>
      {!embedded && (
